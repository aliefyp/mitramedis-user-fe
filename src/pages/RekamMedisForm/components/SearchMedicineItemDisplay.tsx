...
interface SearchMedicineItemDisplayProps {
  item: MedicineType;
  onClick: (item: MedicineType) => void;
}

const SearchMedicineItemDisplay = ({
  item,
  onClick,
}: SearchMedicineItemDisplayProps) => (
  <div
...
export default SearchMedicineItemDisplay;
